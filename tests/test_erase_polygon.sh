...
echo "set output \"erase_polygon.eps\"" > ../gnuplot_instructions.txt
...
echo "\subsection{erase\_polygon(a,b)}" >> ../tex/report.tex
echo "Function draws a polygon in the" >> ../tex/report.tex
echo "screen, using the texture in background. " >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv erase_polygon.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/erase_polygon.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
