...
echo "set output \"new_vector4.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{new\_vector4(a,b,c)}" >> ../tex/report.tex
echo "Function used for creating a 4d vector." >> ../tex/report.tex
echo "" >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv new_vector4.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/new_vector4.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
