...
echo "set output \"erase_circle.eps\"" > ../gnuplot_instructions.txt
...
echo "\subsection{erase\_circle(a,b)}" >> ../tex/report.tex
...
mv erase_circle.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/erase_circle.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
