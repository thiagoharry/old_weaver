...
echo "set output \"destroy_polygon.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{destroy\_polygon(a,b)}" >> ../tex/report.tex
echo "Function used for freeing the memory allocated by a polygon." >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv destroy_polygon.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/destroy_polygon.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
