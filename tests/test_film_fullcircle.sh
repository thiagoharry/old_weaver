...
echo "set output \"film_fullcircle.eps\"" > ../gnuplot_instructions.txt
...
echo "\subsection{film\_fullcircle(a,b)}" >> ../tex/report.tex
echo "This function draw and fills the perimeter of a" >> ../tex/report.tex
echo "circle using the color passed as argument. Drawing" >> ../tex/report.tex
echo "a circle in a arbitrarily big surface, given the" >> ../tex/report.tex
...
mv film_fullcircle.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/film_fullcircle.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
