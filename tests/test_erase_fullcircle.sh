...
echo "set output \"erase_fullcircle.eps\"" > ../gnuplot_instructions.txt
...
echo "\subsection{erase\_fullcircle(a,b)}" >> ../tex/report.tex
echo "This function draws and fills a circle using" >> ../tex/report.tex
echo "the colors in the background surface. Drawing a" >> ../tex/report.tex
...
echo "we are drawing only in the screen, it limits " >> ../tex/report.tex
...
mv erase_fullcircle.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/erase_fullcircle.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
