...
echo "set output \"draw_rectangle.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{draw\_rectangle(a,b,c,d,e)}" >> ../tex/report.tex
echo "Function used for drawing a rectangle in the" >> ../tex/report.tex
echo "screen, given it's coordinates. " >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv draw_rectangle.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/draw_rectangle.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
