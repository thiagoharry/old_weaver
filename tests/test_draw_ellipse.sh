...
echo "set output \"draw_ellipse.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{draw\_ellipse(a,b,c,d,e)}" >> ../tex/report.tex
echo "Function used for drawing a ellipse in the" >> ../tex/report.tex
echo "screen, given it's coordinates. " >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv draw_ellipse.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/draw_ellipse.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
