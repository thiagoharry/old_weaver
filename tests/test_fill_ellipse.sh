...
echo "set output \"fill_ellipse.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{fill\_ellipse(a,b,c,d,e)}" >> ../tex/report.tex
echo "Function used for filling a ellipse in the" >> ../tex/report.tex
echo "screen, given it's coordinates. " >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv fill_ellipse.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/fill_ellipse.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
