...
echo "set output \"draw_circle.eps\"" > ../gnuplot_instructions.txt
echo "set terminal postscript eps enhanced;" >> ../gnuplot_instructions.txt
echo "plot \"data.txt\" with lines;" >> ../gnuplot_instructions.txt

echo "\subsection{draw\_circle(a,b,c,d)}" >> ../tex/report.tex
echo "Function used for drawing a circle in the" >> ../tex/report.tex
echo "screen, given it's coordinates. " >> ../tex/report.tex
gnuplot ../gnuplot_instructions.txt
mv draw_circle.eps ../tex
echo "" >> ../tex/report.tex
echo "\includegraphics{tests/tex/draw_circle.eps}" >> ../tex/report.tex
echo "" >> ../tex/report.tex
